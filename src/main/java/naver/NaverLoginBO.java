...
public class NaverLoginBO {
	private final static String CLIENT_ID = "JEWDm6uD9TW1Io62dEpk";
	private final static String CLIENT_SECRET = "fjGXe3pjtx";
	private final static String REDIRECT_URI = "http://localhost:8080/FinallyProject/callback";
