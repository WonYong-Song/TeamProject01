...
public class Paypal {
   ...
   private Logger logger = LoggerFactory.getLogger(getClass());
...

    {
     ...
     PARAM_AT_VALUE = "N6xnpGsrk3uNCyTRfpIrTe6ynYb_rDi-Ok4IdjKTYEOHU1Qr4g-dFa2XzyC";
    ...
    public String handleRequestPDT(HttpServletRequest request, Model model) throws Exception {
     ...
     if (res.equals(RESPONSE_SUCCESS)) {
      ...
      while ((res = in.readLine()) != null) {
         ...
         logger.info("{}{}{}",new Object[]{temp[0]+":"+temp[0]});
     ...
     model.addAttribute("paymentFee", paymentFee);
