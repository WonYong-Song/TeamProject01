...
<div class="container" >
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="../resources/img/hotel4.jpg" style="width:100%;height:100%" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="../resources/img/hotel5.jpg" style="width:100%;height:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <div class="column">
      <img class="demo cursor" src="../resources/img/H_Chocolate.jpg" style="width:100%;height:100%" onclick="currentSlide(4)" alt="Northern Lights">
    </div>
    <div class="column">
      <img class="demo cursor" src="../resources/img/hotelpront.jpg" style="width:100%;height:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
    </div>    
    <div class="column">
      <img class="demo cursor" src="../resources/img/H_Hotel0.jpg" style="width:100%;height:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
    </div>
  </div>
</div>
<script>
